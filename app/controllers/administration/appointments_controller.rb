class Administration::AppointmentsController < Administration::BaseController
 ...
 @appointment = Appointment.new
  ...
  # POST /turnos.json
  def create   
    @appointment = Appointment.new(appointment_params.merge(state: "Pendiente"))
  ...
  def update
    respond_to do |format|
      if @appointment.update(appointment_params)
        format.html { redirect_to administration_appointment_path, notice: 'Turno modificado correctamente.' }
